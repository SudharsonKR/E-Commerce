...
const productsSlice = createSlice({
    ...
    extraReducers: (builder)=>{
        ...
        .addCase(productsCreate.fulfilled, (state, action) => {
          ...
          toast.success("Product Created!", {position: "bottom-left"});
        })
        ...
        .addCase(productsEdit.fulfilled, (state, action) => {
          const updatedProducts = state.items.map((product)=>product._id === action.payload._id ? action.payload : product);
          state.items = updatedProducts
          state.editStatus = "success";
          toast.error("Product Updated!", {position: "bottom-left"});
        })
        ...
        .addCase(productsDelete.fulfilled, (state, action) => {
          ...
          toast.error("Product Deleted!", {position: "bottom-left"});
        })
